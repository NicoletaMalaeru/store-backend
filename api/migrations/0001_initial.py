# Generated by Django 3.1.3 on 2021-01-10 10:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_postal_code', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('primita', 'Primita'), ('anulata', 'Anulata'), ('pregatire', 'In curs de pregatire'), ('in_livrare', 'Se livreaza'), ('livrata', 'Livrata')], default='primita', max_length=50)),
